<?php
    class Admin extends MY_Controller{
        ...
        function index(){
//            join bảng data
            $this->db->select('group_admin.name_group as name_groupAD, admin.*');
            $this->db->from('admin');
            $this->db->join('group_admin','admin.id_group = group_admin.id');
            $query=$this->db->get();
            $data = $query->result();
            $this->data['list'] = $data;
...
//            $this->data['list'] = $admin_list;
        ...
        function add(){
            ...
            $group_list = $this->group_model->get_list($input);
