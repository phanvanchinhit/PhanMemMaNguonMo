...
<div class="kt-product-tab kt-tab-fadeeffect margin-top-5">
    <ul class="nav-tab">
        <li class="active"><a data-animated="fadeInUp" data-toggle="tab" href="#tab-50">Tất Cả Môn Học</a></li>
    </ul>
        ...
        <div id="tab-50" class="tab-panel active">
            <div class="owl-carousel nav-center nav-style-1">
                ...
                <?php foreach ($product_news as $row): ?>
                    <li class="product-item style9" style="float: left; width: 26.89%; border: 1px solid #E6E6E6">
                        <div class="product-inner">
                            <div class="info col-sm-12" style="text-align: center">
                                ...
                                <div class="group-buttons">
                                    <a class="button add_to_cart_button" href="<?php echo base_url('cart/add/'.$row->id_product); ?>">Đăng Ký</a>
                                </div>
                            </div>
                        </div>
                    </li>
