    ...
    <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
                    ...
                    <form method="get" action="" class="list_filter form">
                        <table width="80%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="item"><input type="text" style="width:55px;" id="filter_id"
                                                        value="<?php echo $this->input->get('id'); ?>" name="id"></td>

                                <td style="width:40px;" class="label"><label for="filter_id">username</label></td>
                                <td style="width:155px;" class="item"><input type="text" style="width:155px;"
                                                                             id="filter_iusername"
                                ...
                                <td style="width:150px">
                                    ...
                                    <input type="reset"
                                           onclick="window.location.href = '<?php echo admin_url('admin'); ?>'; "
            ...
            <tr>
                ...
                <td style="width: 100px;">Chức năng</td>
            </tr>
            </thead>
                ...
                <td colspan="8">
                    <div class="list_action itemActions">
                        <a href="#submit" id="submit" class="button blueB"
                           url="<?php echo admin_url('admin/delete_all'); ?>">
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->id_admin; ?>">
                    ...
                    <td style="text-align: center"><?php echo $row->id_admin; ?></td>
                    <td><?php echo $row->username; ?></td>
                    <td><?php echo $row->name; ?></td>
                    <td><?php echo $row->name_groupAD; ?></td>
                    <td class="option">
                        <a href="<?php echo admin_url('admin/edit/' . $row->id_admin); ?>" title="Chỉnh sửa"
                           class="tipS ">
                            <img src="<?php echo public_url(); ?>/admin/images/icons/color/edit.png"/>
                        </a>

                        <a href="<?php echo admin_url('admin/delete/' . $row->id_admin); ?>" title="Xóa"
