        ...
        <fieldset>
            <div class="widget">
                <div class="title">
                    ...
                    <h6>Cập nhật sản phẩm</h6>
                </div>

                <ul class="tabs">
                    <li><a href="#tab1">Thông tin chung</a></li>
                    <li><a href="#tab2" style="display: none">SEO Onpage</a></li>
                    <li><a href="#tab3" style="display: none">Bài viết</a></li>
                ...
                <div class="tab_container">
                    <div class="tab_content pd0" id="tab1">
                        <div class="formRow">
                            <label for="param_name" class="formLeft">Tên Môn Học:<span class="req">*</span></label>
                            <div class="formRight">
                        ...
                        <div class="formRow" style="display: none">
                            ...
                            <div class="formRight">
                                ...
                                <img src="<?php echo base_url('upload/products/' . $product_info->image_link); ?>"
                            ...
                            <div class="formRight">
                                ...
                                <?php if (is_array($image_list)) { ?>
                                    <?php foreach ($image_list as $img): ?>
                                        <img src="<?php echo base_url('upload/products/' . $img); ?>"
                                             style="height: 70px; width: 100px; margin: 5px;">
                                    <?php endforeach;
                                } ?>
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="formRow" style="display: none">
                            ...
                            <div class="formRight">
		<span class="oneTwo">
			<input type="text" _autocheck="true" value="<?php echo number_format($product_info->price); ?>"
                   class="format_number" id="param_price" style="width:100px" name="price">
			<img src="<?php echo public_url(); ?>/admin/crown/images/icons/notifications/information.png"
                 style="margin-bottom:-8px" title="Giá bán sử dụng để giao dịch" class="tipS">
		</span>
                        ...
                        <div class="formRow" style="display: none">
                            ...
                            <div class="formRight">
		<span>
			<input type="text" class="format_number" value="<?php echo number_format($product_info->discount); ?>"
                   id="param_discount" style="width:100px" name="discount">
			<img src="<?php echo public_url(); ?>/admin/crown/images/icons/notifications/information.png"
                 style="margin-bottom:-8px" title="Số tiền giảm giá" class="tipS">
		</span>
                        ...
                        <div class="formRow">
                            <label for="param_cat" class="formLeft">Khoa - Lớp:<span class="req">*</span></label>
                            <div class="formRight">
                                <select name="catalog">
                                    <option value=""></option>
                        ...
                        <div class="formRow" style="display: none">
                            ...
                            <div class="formRight">
                                <span class="oneFour"><input type="text" id="param_warranty"
                        ...
                        <div class="formRow" style="display: none">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea cols="" rows="4" id="param_sale"
                                                               name="gifts"><?php echo $product_info->gifts ?></textarea></span>
                    ...
                    <div class="tab_content pd0" id="tab2">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea cols="" rows="4" _autocheck="true" id="param_site_title"
                                                               name="site_title"><?php echo $product_info->site_title ?></textarea></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea cols="" rows="4" _autocheck="true" id="param_meta_desc"
                                                               name="meta_desc"><?php echo $product_info->meta_desc ?></textarea></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea cols="" rows="4" _autocheck="true" id="param_meta_key"
                                                               name="meta_key"><?php echo $product_info->meta_key ?></textarea></span>
                    ...
                    <div class="tab_content pd0" id="tab3">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <textarea class="editor" id="param_content"
                                          name="content"><?php echo $product_info->content ?></textarea>
