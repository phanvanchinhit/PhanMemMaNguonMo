    ...
    <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
            ...
            <tr>
                ...
                <td style="width: 100px;">Tên khoa - Lớp</td>
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->id_catalog; ?>">
                    ...
                    <td style="color:red; text-transform: uppercase; font-weight: bold;"><?php echo $row->name; ?>
            ...
            <?php foreach ($row->subs as $sub): ?>
                <tr class="row_<?php echo $sub->id_catalog; ?>">
                    <td><input type="checkbox" name="id[]" value="<?php echo $row->id_catalog; ?>" /></td>
                    <td style="padding-left: 30px;font-weight: bold;text-transform: capitalize;"> <?php echo $sub->name; ?>
